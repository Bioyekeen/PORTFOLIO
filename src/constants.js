...
export const contactLinks = [{ name: 'Stack Overflow', url: 'https://img.icons8.com/external-tal-revivo-color-tal-revivo/40/000000/external-stack-overflow-is-a-question-and-answer-site-for-professional-logo-color-tal-revivo.png', link: 'https://stackoverflow.com/users/20584997/biodun-samuel-yekeen' },
{ name: 'Github', url: 'https://img.icons8.com/doodle/40/000000/github--v1.png', link :'https://github.com/Bioyekeen'},
{ name: 'LinkedIn', url: 'https://img.icons8.com/doodle/40/000000/linkedin--v2.png', link: 'https://www.linkedin.com/in/biodun-yekeen-669737b3/'}
]
...
export const serviceData = [
  ...
  },
  {
    ...
    desc: `Responsible for developing new user-facing features, 
...

  {
    ...
    desc: `Responsible for server-side web application logic 
    and integration of the work front-end developers do. Usually write the 
    web services and APIs used by front-end developers.`,
